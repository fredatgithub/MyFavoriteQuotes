    ...
    "</Document>"
      ...
      "</terms>"
        ...
        private void buttonDuplicate_Click(object sender, EventArgs e)
        {
            ...
            textBoxDuplicate.Text += $@"There {Punctuation.Pluralize(allQuotesWithDuplicate.ListOfQuotes.Count, "are")}  {allQuotesWithDuplicate.ListOfQuotes.Count} quote{Punctuation.Pluralize(allQuotesWithDuplicate.ListOfQuotes.Count)} which are duplicate";
            textBoxDuplicate.Text += Environment.NewLine;
            if (allQuotesWithDuplicate.ListOfQuotes.Count > 0)
            {
                textBoxDuplicate.Text += $@"The duplicate {Punctuation.Pluralize(allQuotesWithDuplicate.ListOfQuotes.Count, "are")}:";
                textBoxDuplicate.Text += Environment.NewLine;
